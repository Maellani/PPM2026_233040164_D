...
class DbHelper {
  ...
  static const _dbVersion = 2; // Naikkan versi ke 2
  ...
  Future<Database> _openDb() async {
    ...
    return openDatabase(
      ...
      // Tambahkan onUpgrade untuk menangani update kolom email jika belum ada
      onUpgrade: (db, oldVersion, newVersion) async {
        if (oldVersion < 2) {
          await db.execute('ALTER TABLE $tabel ADD COLUMN email TEXT NOT NULL DEFAULT ""');
        }
      },
    );
  }
